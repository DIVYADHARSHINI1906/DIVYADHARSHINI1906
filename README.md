...
```javascript
const divyadharshini = {
  name     : "DIVYADHARSHINI B",
  location : "Tiruchengode, Tamil Nadu 🇮🇳",
  degree   : "B.E. CSE — CGPA: 8.12",
  college  : "KSR Institute of Engineering & Technology",
  stack    : ["React.js","JavaScript","HTML5","CSS3",
              "Bootstrap 5","Firebase","PostgreSQL","PHP"],
  learning : ["Advanced React","Node.js","Flutter","System Design"],
  motto    : () => "Build with purpose. Ship with pride. 🚀"
};
```
...
![REST API](https://img.shields.io/badge/REST%20API-0052CC?style=flat-square&logo=fastapi&logoColor=white)
...
<details>
<summary><b>🏢 GOCOSYS, Erode — Frontend Developer Intern &nbsp;|&nbsp; Mar 2025 – Present</b></summary>
<br/>
...
- 🌐 Full company portfolio — live at [gocosys.com](http://gocosys.com/)
- 🎨 Mobile-first responsive UI with smooth animations
- ⚙️ PHP + MySQL backend + Firebase contact form
- ✅ Cross-browser compatible, SEO-optimized

</details>

<details>
<summary><b>🏢 Imagivite Technology, Tiruchengode — Software Developer Intern &nbsp;|&nbsp; May 2025 – Aug 2025</b></summary>
<br/>
...
- 🌟 **2-month extension** for outstanding performance
- 📚 **LearningSaga** — live e-learning React.js UI
- 🖥️ **Vibhu** — frontend modules, cross-device UI
- 🔄 Agile, code reviews, senior dev collaboration

</details>

<details>
<summary><b>🏢 Bluestock Fintech — SDE Intern &nbsp;|&nbsp; Dec 2025 – Jan 2026</b></summary>
<br/>

> ![HTML5](https://img.shields.io/badge/HTML5-E34F26?style=flat-square&logo=html5&logoColor=white) ![React](https://img.shields.io/badge/React.js-61DAFB?style=flat-square&logo=react&logoColor=black)

- 💼 30-day SDE internship — HTML, CSS, JS, React in fintech

</details>

<details>
<summary><b>🏢 AccentTechnoSoft, Coimbatore — Data Science Intern &nbsp;|&nbsp; Jul 2024 – Aug 2024</b></summary>
<br/>
...
- 🤖 Diabetes Prediction Model — Scikit-learn, EDA, confusion matrix
...
|:--------|:------|:-----------|
| 🌐 [**GOCOSYS Landing Page**](http://gocosys.com/) | Bootstrap 5, HTML5, JS, PHP, MySQL, Firebase | Live · Mobile-first · Real-time backend · SEO |
| 📚 **LearningSaga E-Learning** | React.js, CSS3, JavaScript | Live production · Course listing · Dynamic UI |
| 🩺 **Diabetes Prediction System** | Python, Scikit-learn, Pandas | MSME-recognised · ML · EDA |
| 📖 **Student Library Record System** | Java | CRUD · Search · Analytics reports |
...
| | Achievement | Details |
|:--:|:------------|:--------|
| 🥈 | **2nd Place — Project Expo** | Dhirajlal Gandhi College of Technology |
| 🇮🇳 | **Smart India Hackathon 2024** | National Level — Blind Shoe IoT |
| 🏅 | **MSME Recognition** | Healthcare Technology Innovation |
| 🌟 | **GDG KSRIET — AI/ML Lead** | Events coordination & peer mentoring |
| 💯 | **SSLC Perfect Score** | 100% in Class X |
...
|:-------|:------------|:----:|:-----:|
| 🎓 B.E. CSE | KSRIET, Tiruchengode | 2023 – Present | **8.12 CGPA** |
| 📘 Class XII — Science | JKK Nattraja Matric HSS | 2022 – 2023 | **77%** |
| 📗 Class X — SSLC | JKK Nattraja Matric HSS | 2019 – 2020 | **100%** |
...
🌐 Node.js & APIs    →  Express.js · REST Design · Auth Patterns
📱 Flutter           →  Dart · UI Components · State Management
🗄️ System Design     →  Scalability · Caching · Microservices
```
